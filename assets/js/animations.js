...
ellipsisBtn.addEventListener("click", () => {
  if (!isOpen) {
    ...
    gsap.to(overflowMenu, { paddingTop: 36, paddingBottom: 8, duration: 0.2 });
    gsap.to(menuItems, {
      opacity: 1,
      y: 0,
      duration: 0.3,
    ...
    // FECHAR
    gsap.to(overflowMenu, { paddingTop: 0, paddingBottom: 0, duration: 0.2 });
    gsap.to(menuItems, {
      opacity: 0,
      y: -16,
      duration: 0.2,
      ease: "power2.in",
      stagger: 0.04,
      onComplete: () => gsap.set(menuItems, { display: "none" }),
    });
  }
